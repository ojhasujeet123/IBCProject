...
//                 console.log('its transaction receipt ' , transactionReceipt)
//                 let transactionData = {
...
purpose - bypassing the contract address
*/ 
        ...
        if(block.transactions && block.transactions.length > 0){ 
            for(s = 0; s <  block.transactions.length ; s++){ 
                ...
                let transactionData = {
                    ...
                    blockHash:transaction.blockHash,
                    from:transaction.from,
                    to:transaction.to===null?transactionReceipt.contractAddress:transaction.to,
                    hash:transaction.hash,
                    value:transaction.value , //web3.utils.fromWei(transaction.value, 'ether'),
                    gas:transaction.gas, 
                    gasPrice:transaction.gasPrice, 
